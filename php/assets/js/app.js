...
var v = new Vue({
    ...
    methods: {
        showAll() {
            axios.get(API_URL + "user/showAll").then(function (response) {
        ...
        searchUser() {
            ...
            axios.post(API_URL + "user/searchUser", formData).then(function (response) {
                if (response.data.users == null) {
                    v.noResult()
                } else {
                    v.getData(response.data.users);
        ...
        addUser() {
            ...
            axios.post(API_URL + "user/addUser", formData).then(function (response) {
        ...
        updateUser() {
            var formData = v.formData(v.chooseUser); axios.post(API_URL + "user/updateUser", formData).then(function (response) {
                if (response.data.error) {
                    v.formValidate = response.data.msg;
                } else {
        ...
        deleteUser() {
            ...
            axios.post(API_URL + "user/deleteUser", formData).then(function (response) {
                if (!response.data.error) {
                    v.successMSG = response.data.success;
                    v.clearAll();
                    v.clearMSG();
